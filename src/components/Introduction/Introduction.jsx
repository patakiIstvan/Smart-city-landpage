...
import listDecoration from '../../assets/svg/ul-decoration.svg'
  ...
  return (
    <section className='section introduction'>
      ...
      <div className="container">
        ...
        <ul>
          <li style={{ listStyleImage: `url(${listDecoration})` }}><strong>Principles</strong> - At the top are four principles that provide the foundation for Web accessibility</li>
          <li style={{ listStyleImage: `url(${listDecoration})` }}><strong>Guidelines</strong> - Under the principles are guidelines.</li>
          <li style={{ listStyleImage: `url(${listDecoration})` }}><strong>Sufficient and Advisory Techniques</strong> - For each of the guidelines and success criteria in the WCAG 2.0 document itself</li>
        </ul>
